...
if TYPE_CHECKING:
    from ..objects.fs.base import FileSystem
...
class Repo:
    ...
    def _get_repo_dirs(
        ...
        from ..objects.fs import localfs
    ...
    def __init__(
        ...
        from ..objects.fs import GitFileSystem, LocalFileSystem, localfs
        ...
        from ..data.hashfile.state import State, StateNoop
    ...
    def scm_context(self) -> "SCMContext":
        from ..repo.scm_context import SCMContext
    ...
    def get_rev(self):
        from ..objects.fs import LocalFileSystem
    ...
    def find_root(cls, root=None, fs=None) -> str:
        from ..objects.fs import LocalFileSystem, localfs
    ...
    @cached_property
    def datafs(self):
        from ..objects.fs.data import DataFileSystem
