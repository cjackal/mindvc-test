...
if TYPE_CHECKING:
    from ...objects.fs.base import AnyFSPath, FileSystem
...
def _upload_file(from_path, fs, odb, upload_odb, callback=None):
    ...
    from ...objects.fs.utils import tmp_fname
...
def _make_staging_url(
    ...
    from ...objects.fs import Schemes
...
def _get_staging(odb: "HashFileDB") -> "ReferenceHashFileDB":
    ...
    from ...objects.fs import MemoryFileSystem
