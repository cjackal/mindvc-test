...
from ....objects.db import noop, wrap_iter
from ....objects.errors import ObjectDBError, ObjectFormatError
from ....objects.fs.system import umask
from ....objects.fs.utils import copyfile, relpath, remove
...
class LocalHashFileDB(HashFileDB):
    ...
    def makedirs(self, path):
        from ....objects.fs.utils import makedirs
